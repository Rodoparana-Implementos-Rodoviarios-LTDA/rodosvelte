<script lang="ts">
	...
	// Função para carregar os dados do usuário a partir do sessionStorage
	...
	// Função de logout utilizando sessionStorage
	function handleLogout() {
		if (typeof window !== 'undefined') {
			sessionStorage.removeItem('username'); // Remove o nome de usuário
