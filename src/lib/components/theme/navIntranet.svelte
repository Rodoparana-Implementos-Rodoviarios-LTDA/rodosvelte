...
<div class="drawer">
	...
	<div class="drawer-content flex flex-col">
		...
		<!-- Conteúdo do slot (restante da página principal) -->
		<slot />
	</div>
	...
	<div class="drawer-side h-screen z-20">
		...
		<ul class="menu p-4 w-80 bg-base-200 text-base-content h-screen flex flex-col overflow-y-auto">
			...
			<div class="bg-base-300 rounded-xl p-4 mb-2 hover:bg-base-100">
				<span class="flex items-center space-x-3 rounded-lg transition duration-200 ease-in-out text-lg font-medium">
					Inicio
				</span>
			</div>

			<!-- Accordion para as seções dinâmicas -->
