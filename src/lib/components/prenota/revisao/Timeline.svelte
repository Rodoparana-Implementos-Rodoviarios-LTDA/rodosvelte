...
<div class="h-full">
	<div class="flex justify-between items-start">
		<h2 class="text-2xl text-start font-bold pb-10">Histórico de Eventos</h2>
		<button class="btn btn-sm btn-outline btn-info w-fit">Anexos</button>
	</div>
		...
		{#if criacao}
			<li>
				...
				<div class="timeline-end timeline-box">
					<span class="font-bold">Criado por:</span>
					{criacao.usuario}
				</div>
				<hr class="bg-info" />
			</li>
