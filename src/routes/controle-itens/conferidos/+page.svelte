<script lang="ts">
	...
	import { columns } from '$lib/components/portaria/itensConferidos/columns'; // Importa as colunas
	...
	export let endpoint: string = 'api/pneus/historico';
...
<div class="h-full">
	...
	<div class="fixed top-8 left-1/2 transform -translate-x-1/2 text-center">
		<h1 class="text-3xl font-bold">Histórico de Itens Conferidos</h1>
	</div>
